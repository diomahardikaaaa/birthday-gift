...
window.ConfettiGenerator = function (e) {
  ...
  function r(e) {
    ...
    switch (
      ...
      case "square":
        ...
        break;
      case "image":
        n.drawImage(e.image, e.x, e.y, 100 * a.size, 100 * a.size);
    }
  }
  ...
  faceImage.src = "file/foto.png"; // Change to the path of the face image
  ...
  return {
    render: function () {
      ...
      for (var c = 0; c < a.max; c++) {
        var confetti = i();
        // Add face image as confetti
        confetti.prop = "image";
        confetti.image = faceImage;
        l.push(confetti);
      }
